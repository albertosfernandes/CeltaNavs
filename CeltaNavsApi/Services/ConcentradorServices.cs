...
namespace CeltaNavsApi.Services
{
    public class ConcentradorServices
    {
        ...
        //não utilizo resolvi fazer direto no Dao do SaleRequest
        //public string MarkSaleRequest(CeltaNavs.Repository.ModelSaleRequests _saleRequest)
        //{
        //    var content = new ObjectContent<CeltaNavs.Repository.ModelSaleRequests>(_saleRequest, new JsonMediaTypeFormatter());
        //    HttpResponseMessage response = null;

        //    try
        //    {
        //        response = _httpClient.PutAsync("api/APISalerequest/Update/", content).Result;
        //        if (response.IsSuccessStatusCode)
